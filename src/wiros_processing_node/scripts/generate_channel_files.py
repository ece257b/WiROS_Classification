...
#path to a bag file
print("Loading bag...")
bag = rosbag.Bag("/home/wcsng-robot/ipsn_ws/src/wiros_processing_node/data319_fft_fah1.bag")

#dir to output processed data
out = "/home/wcsng-robot/ipsn_ws/src/wiros_processing_node/data319_fft_fah1/"

#optional compensation path, set to None to not use.
comp = "/home/wcsng-robot/ipsn_ws/comp_files_157/192.168.43.226-157.npy"
