...
#path to a bag file
print("Loading bag...")
bag = rosbag.Bag("/home/wcsng-robot/ipsn_ws/src/wiros_processing_node/data308.bag")

#dir to output processed data
out = "/home/wcsng-robot/ipsn_ws/src/wiros_processing_node/data308/"

#optional compensation path, set to None to not use.
comp = None#"~/compensation/192.168.1.1-42.npy"
    ...
    if key not in channels.keys():
        ...
        if use_aoa:
            ...
            if aoa_algo == 'full_svd':
                ...
                aoa_sensors[key],profs[key] = transform_utils.fft_aoa_sensor(rx_pos, theta_space, tof_space)
            elif aoa_algo == 'music':
